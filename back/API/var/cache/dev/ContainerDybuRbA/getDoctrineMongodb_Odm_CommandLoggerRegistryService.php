...
class getDoctrineMongodb_Odm_CommandLoggerRegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['doctrine_mongodb.odm.command_logger_registry'] = new \Doctrine\Bundle\MongoDBBundle\APM\CommandLoggerRegistry(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['doctrine_mongodb.odm.command_logger'] ?? $container->load('getDoctrineMongodb_Odm_CommandLoggerService'));
            yield 1 => ($container->privates['doctrine_mongodb.odm.data_collector.command_logger'] ?? ($container->privates['doctrine_mongodb.odm.data_collector.command_logger'] = new \Doctrine\ODM\MongoDB\APM\CommandLogger()));
        }, 2));
    }
}
