...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.request', [0 => function () {
            return ($this->privates['SymfonyBundles\\JsonRequestBundle\\EventListener\\RequestTransformerListener'] ?? ($this->privates['SymfonyBundles\\JsonRequestBundle\\EventListener\\RequestTransformerListener'] = new \SymfonyBundles\JsonRequestBundle\EventListener\RequestTransformerListener()));
        }, 1 => 'onKernelRequest'], 0);
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1M1312mHM4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
